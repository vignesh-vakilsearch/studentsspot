...
class DetailsControllerTest < ActionController::TestCase
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post :create, detail: { college: @detail.college, image: @detail.image, name: @detail.name, preexam: @detail.preexam, sex: @detail.sex }
    end
  ...
  test "should update detail" do
    patch :update, id: @detail, detail: { college: @detail.college, image: @detail.image, name: @detail.name, preexam: @detail.preexam, sex: @detail.sex }
    assert_redirected_to detail_path(assigns(:detail))
  end
